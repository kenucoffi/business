    ...
    <div className="w-full h-full ">        
        <div className="relative h-[450px] w-full overflow-auto">
            ...
            <div className="absolute h-full w-full overflow-hidden bg-indigo-600/70 ">
                <NavForbus/>
                <div className="w-full h-full overflow-hidden text-center flex justify-center items-center"> <h1 className="text-white text-3xl md:text-5xl md:w-xl w-md">We are designing a new way to do business</h1></div>
            </div>
        </div>
       <div className="relative flex flex-col w-full h-[400px] items-center justify-center mt-[-160px]">
            <div className="relative  lg:w-[700px] md:w-[500px] w-[400px] h-[300px]  ">
                <Image src="/peoples.jpg" alt="image" fill/> 
            </div>
            <div className="absolute bottom-2 flex justify-center">
       <div className="flex flex-row justify-between items-center  h-[80px] lg:w-[500px] w-[300px]  bg-sky-400 shadow-xl shfadow-gray-300">
       ...
       <div className="space-y-4 mt-10 mb-5 flex flex-col justify-center items-center">
        ...
        <p className="md:w-2xl sm:w-lg w-md text-lg text-gray-400">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum. 
        ...
        <p className="md:w-2xl sm:w-lg w-md text-lg text-gray-400">
